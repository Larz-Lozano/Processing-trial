...
//slider bar
  ...
  int[] yBrush={260,304,348,392,436,480,524,568,612,656};
  int[] sBrush={2,5,10,20,50,80,100,150,200,250};
  for (int i=0; i<yBrush.length; i++) {
  fill(255);
